...
public class BranchBean extends DefaultBean {
	...
	public void loadManager() {
		...
		try {
			...
			this.manager = this.collaboratorService
					.findCollaborator(this.branchSearch, SoldCodeEnum.MANAGER);
			...
			errorMessage("error.search", Messages.getMessage("label.manager"));
		} catch (Exception e) {
			fatalMessage("fatal.error");
		} 
	}
	...
	public void loadRegional() {
		...
		try {
			...
			this.regional = this.collaboratorService
					.findCollaborator(this.branchSearch, SoldCodeEnum.REGIONAL);
			...
			errorMessage("error.search", Messages.getMessage("label.regional"));
		} catch (Exception e) {
			fatalMessage("fatal.error");
		}  
	}
