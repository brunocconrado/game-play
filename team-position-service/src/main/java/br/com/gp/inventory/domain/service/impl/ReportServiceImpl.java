...
import br.com.gp.inventory.domain.enumeration.ReportEnum;
...
import br.com.gp.inventory.domain.service.ConfigurationService;
import br.com.gp.inventory.domain.service.ReportService;
import br.com.gp.inventory.domain.service.SituationService;
import br.com.gp.inventory.domain.service.SoldCodeService;
...
public class ReportServiceImpl implements ReportService {
	...
	public void approveReprove(TeamSellerSearch search,
		...
		try {
			...
			Collaborator approver = collaboratorService.findByRegistry(user.getRegistry());
			this.teamSellerService.concludeRegistry(search.getBranchId(), 
					approved ? StatusEnum.APPROVED : StatusEnum.REPROVED, approver, message, true);
